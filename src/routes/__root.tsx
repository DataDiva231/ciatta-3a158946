...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Ciatta reads your sleep, recovery and cycle signals and tells you what your body is asking for today." },
      { property: "og:description", content: "Ciatta reads your sleep, recovery and cycle signals and tells you what your body is asking for today." },
      { name: "twitter:description", content: "Ciatta reads your sleep, recovery and cycle signals and tells you what your body is asking for today." },
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <div className="flex min-h-screen justify-center bg-secondary">
        <div className="relative flex min-h-screen w-full max-w-[430px] flex-col bg-background shadow-[0_0_80px_-30px_rgba(24,24,27,0.25)]">
